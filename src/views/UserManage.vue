      ...
      <el-row>
        ...
        <el-col :span="12">
          <div class="userManage_right">
            <!-- <div class="userManage_right_user">
            ...
            <el-form label-width="100px" :model="formLabelAlign">
              ...
              <el-form-item :label="$t('性别')">
                <el-select :disabled="show" v-model="formLabelAlign.gender" placeholder="请选择性别" style="width:50%" filterable clearable>
                  <el-option :label="$t('男')" :value="0" />
                  <el-option :label="$t('女')" :value="1" />
                </el-select>
              </el-form-item>
              <el-form-item :label="$t('地址')">
                <el-input :disabled="show" v-model="formLabelAlign.address" style="width:50%"></el-input>
              </el-form-item>
              <el-form-item :label="$t('联系电话')">
                <el-input :disabled="show" v-model="formLabelAlign.phone" style="width:50%"></el-input>
              </el-form-item>
              <el-form-item :label="$t('邮箱')">
                <el-input :disabled="show" v-model="formLabelAlign.email" style="width:50%"></el-input>
              </el-form-item>
              <el-form-item :label="$t('个性签名')">
                <el-input :disabled="show" v-model="formLabelAlign.signature" style="width:50%" maxlength="20" show-word-limit></el-input>
              </el-form-item>
            </el-form>
            <div class="wall">
              <!-- <span>照片墙</span> -->
        ...
        <el-col :span="16">
          <div class="BaseTable_right">
            <el-form label-width="100px" :model="formLabelAlign" :disabled="show">
              ...
              <el-form-item :label="$t('出生日期')">
                <el-date-picker v-model="formLabelAlign.birth" type="date" format="YYYY-MM-DD" style="width:50%" @change="changetime" />
              </el-form-item>
              <el-form-item :label="$t('性别')">
